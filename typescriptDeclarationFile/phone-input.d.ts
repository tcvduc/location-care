...
> {
  ...
  style?: ViewStyle;
  /**
   * Custom styles for flag image
   * eg (exempli gratia - Latin).
   * {{width:50, height:30}}
   */
  flagStyle?: ImageStyle;
  /**
   * Custom styles for phone number text input
   * eg.
   * {{fontSize:14}}
   *
   */
  textStyle?: TextStyle;
  /**
   * Properties for phone number text input
   * eg.
  ...
  pickerBackgroundColor?: string;
  /**
   * Custom styles for text in country picker
   */
...
> extends React.Component<ReactNativePhoneInputProps<TextComponentType>> {
   ...
   * Return flag image
   */
  getFlag: (iso: string) => ImageRequireSource;
  /**
  ...
  /**
   * Return country dial code of current phone
   * number
   */
  getCountryCode: () => string;
  /**
   * Return country iso code of current phone numb er
   */
  getISOCode: () => string;
}
